...
[_LAYER0] = LAYOUT(
        ...
        LSFT_T(KC_F12), KC_Z   ,   KC_X   , KC_C ,   KC_V          , KC_B   , KC_ENT,                KC_N ,   KC_M   , LZF_7  , LZF_6  , KC_ENT , KC_RSFT, KC_UP  ,
        KC_LCTL       , KC_LALT,   KC_LGUI, MO(1),   KC_LCTL       , KC_LSFT, LT(2,KC_SPC), KC_RGUI, MO(4),   KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT
    ),
